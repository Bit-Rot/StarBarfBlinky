...
class Adafruit_NeoPixel {
 ...
 public:
  ...
  void
    ...
    setPixelColorWithBrightness(uint16_t n, uint8_t r, uint8_t g, uint8_t b, uint8_t brightness),
    setPixelColor(uint16_t n, uint8_t r, uint8_t g, uint8_t b, uint8_t w),
    setPixelColorWithBrightness(uint16_t n, uint32_t c, uint8_t brightness),
